...
import { CrearPedidoRequest, PedidoCliente, PedidoCreado, StripePaymentIntent } from './pedido.model';
...
export abstract class PedidoRepository {
  ...
  abstract iniciarPagoStripe(pedidoId: number): Observable<StripePaymentIntent>;
